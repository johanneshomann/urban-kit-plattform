...
export async function generateMetadata({
  ...
  return { title: t('barrierefreiheitMeta') }
}

export default async function BarrierefreiheitPage({ params }: { params: Promise<{ locale: string }> }) {
  const { locale } = await params
  const t = await getTranslations({ locale, namespace: 'legal' })
